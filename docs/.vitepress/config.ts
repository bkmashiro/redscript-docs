        ...
        sidebar: {
          ...
          '/en/stdlib/': [
            ...
            { text: 'Mathematics', items: [
              ...
              { text: 'ode', link: '/en/stdlib/ode' },
              { text: 'linalg', link: '/en/stdlib/linalg' },
            ]},
            { text: 'Data Structures', items: [
              ...
              { text: 'graph', link: '/en/stdlib/graph' },
              { text: 'heap', link: '/en/stdlib/heap' },
              { text: 'map', link: '/en/stdlib/map' },
              { text: 'queue', link: '/en/stdlib/queue' },
              { text: 'set_int', link: '/en/stdlib/set_int' },
              { text: 'sort', link: '/en/stdlib/sort' },
            ]},
            ...
            { text: 'Minecraft Mechanics', items: [
              ...
              { text: 'scheduler', link: '/en/stdlib/scheduler' },
              { text: 'result', link: '/en/stdlib/result' },
              { text: 'ecs', link: '/en/stdlib/ecs' },
              { text: 'dialog', link: '/en/stdlib/dialog' },
              { text: 'events', link: '/en/stdlib/events' },
              { text: 'pathfind', link: '/en/stdlib/pathfind' },
        ...
        sidebar: {
          ...
          '/zh/stdlib/': [
            ...
            { text: '数学', items: [
              ...
              { text: 'ode', link: '/zh/stdlib/ode' },
              { text: 'linalg', link: '/zh/stdlib/linalg' },
            ]},
            { text: '数据结构', items: [
              ...
              { text: 'graph', link: '/zh/stdlib/graph' },
              { text: 'heap', link: '/zh/stdlib/heap' },
              { text: 'map', link: '/zh/stdlib/map' },
              { text: 'queue', link: '/zh/stdlib/queue' },
              { text: 'set_int', link: '/zh/stdlib/set_int' },
              { text: 'sort', link: '/zh/stdlib/sort' },
            ]},
            { text: '随机数与统计', items: [
            ...
            { text: 'Minecraft 游戏机制', items: [
              ...
              { text: 'scheduler', link: '/zh/stdlib/scheduler' },
              { text: 'result', link: '/zh/stdlib/result' },
              { text: 'ecs', link: '/zh/stdlib/ecs' },
              { text: 'dialog', link: '/zh/stdlib/dialog' },
              { text: 'events', link: '/zh/stdlib/events' },
              { text: 'pathfind', link: '/zh/stdlib/pathfind' },
