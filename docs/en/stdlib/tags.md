...
> Auto-generated from `src/stdlib/tags.mcrs` — do not edit manually.

## API

- [BLOCK_MINEABLE_AXE](#block-mineable-axe)
- [BLOCK_MINEABLE_HOE](#block-mineable-hoe)
- [BLOCK_MINEABLE_PICKAXE](#block-mineable-pickaxe)
- [BLOCK_MINEABLE_SHOVEL](#block-mineable-shovel)
- [BLOCK_ALL_HANGING_SIGNS](#block-all-hanging-signs)
- [BLOCK_ALL_SIGNS](#block-all-signs)
- [BLOCK_ANCIENT_CITY_REPLACEABLE](#block-ancient-city-replaceable)
- [BLOCK_ANIMALS_SPAWNABLE_ON](#block-animals-spawnable-on)
- [BLOCK_ANVIL](#block-anvil)
- [BLOCK_AXOLOTLS_SPAWNABLE_ON](#block-axolotls-spawnable-on)
- [BLOCK_AZALEA_GROWS_ON](#block-azalea-grows-on)
- [BLOCK_AZALEA_ROOT_REPLACEABLE](#block-azalea-root-replaceable)
- [BLOCK_ACACIA_LOGS](#block-acacia-logs)
- [BLOCK_BAMBOO_BLOCKS](#block-bamboo-blocks)
- [BLOCK_BAMBOO_PLANTABLE_ON](#block-bamboo-plantable-on)
- [BLOCK_BANNERS](#block-banners)
- [BLOCK_BASE_STONE_NETHER](#block-base-stone-nether)
- [BLOCK_BASE_STONE_OVERWORLD](#block-base-stone-overworld)
- [BLOCK_BEACON_BASE_BLOCKS](#block-beacon-base-blocks)
- [BLOCK_BEDS](#block-beds)
- [BLOCK_BEEHIVES](#block-beehives)
- [BLOCK_BEE_GROWABLES](#block-bee-growables)
- [BLOCK_BIG_DRIPLEAF_PLACEABLE](#block-big-dripleaf-placeable)
- [BLOCK_BIRCH_LOGS](#block-birch-logs)
- [BLOCK_BUTTONS](#block-buttons)
- [BLOCK_CAMEL_SAND_STEP_SOUND_BLOCKS](#block-camel-sand-step-sound-blocks)
- [BLOCK_CAMPFIRES](#block-campfires)
- [BLOCK_CANDLE_CAKES](#block-candle-cakes)
- [BLOCK_CANDLES](#block-candles)
- [BLOCK_CAULDRONS](#block-cauldrons)
- [BLOCK_CAVE_VINES](#block-cave-vines)
- [BLOCK_CEILING_HANGING_SIGNS](#block-ceiling-hanging-signs)
- [BLOCK_CHERRY_LOGS](#block-cherry-logs)
- [BLOCK_CLIMBABLE](#block-climbable)
- [BLOCK_COAL_ORES](#block-coal-ores)
- [BLOCK_COMBINATION_STEP_SOUND_BLOCKS](#block-combination-step-sound-blocks)
- [BLOCK_COMPLETES_FIND_TREE_TUTORIAL](#block-completes-find-tree-tutorial)
- [BLOCK_CONCRETE_POWDER](#block-concrete-powder)
- [BLOCK_CONVERTABLE_TO_MUD](#block-convertable-to-mud)
- [BLOCK_COPPER_ORES](#block-copper-ores)
- [BLOCK_CORALS](#block-corals)
- [BLOCK_CORAL_BLOCKS](#block-coral-blocks)
- [BLOCK_CORAL_PLANTS](#block-coral-plants)
- [BLOCK_CRIMSON_STEMS](#block-crimson-stems)
- [BLOCK_CROPS](#block-crops)
- [BLOCK_CRYSTAL_SOUND_BLOCKS](#block-crystal-sound-blocks)
- [BLOCK_DAMPENS_VIBRATIONS](#block-dampens-vibrations)
- [BLOCK_DARK_OAK_LOGS](#block-dark-oak-logs)
- [BLOCK_DEAD_BUSH_MAY_PLACE_ON](#block-dead-bush-may-place-on)
- [BLOCK_DEEPSLATE_ORE_REPLACEABLES](#block-deepslate-ore-replaceables)
- [BLOCK_DIAMOND_ORES](#block-diamond-ores)
- [BLOCK_DIRT](#block-dirt)
- [BLOCK_DOORS](#block-doors)
- [BLOCK_DRAGON_IMMUNE](#block-dragon-immune)
- [BLOCK_DRAGON_TRANSPARENT](#block-dragon-transparent)
- [BLOCK_DRIPSTONE_REPLACEABLE_BLOCKS](#block-dripstone-replaceable-blocks)
- [BLOCK_EMERALD_ORES](#block-emerald-ores)
- [BLOCK_ENCHANTMENT_POWER_PROVIDER](#block-enchantment-power-provider)
- [BLOCK_ENCHANTMENT_POWER_TRANSMITTER](#block-enchantment-power-transmitter)
- [BLOCK_ENDERMAN_HOLDABLE](#block-enderman-holdable)
- [BLOCK_FALL_DAMAGE_RESETTING](#block-fall-damage-resetting)
- [BLOCK_FEATURES_CANNOT_REPLACE](#block-features-cannot-replace)
- [BLOCK_FENCE_GATES](#block-fence-gates)
- [BLOCK_FENCES](#block-fences)
- [BLOCK_FIRE](#block-fire)
- [BLOCK_FLOWER_POTS](#block-flower-pots)
- [BLOCK_FLOWERS](#block-flowers)
- [BLOCK_FOXES_SPAWNABLE_ON](#block-foxes-spawnable-on)
- [BLOCK_FROG_PREFER_JUMP_TO](#block-frog-prefer-jump-to)
- [BLOCK_FROGS_SPAWNABLE_ON](#block-frogs-spawnable-on)
- [BLOCK_GEODE_INVALID_BLOCKS](#block-geode-invalid-blocks)
- [BLOCK_GOATS_SPAWNABLE_ON](#block-goats-spawnable-on)
- [BLOCK_GOLD_ORES](#block-gold-ores)
- [BLOCK_GUARDED_BY_PIGLINS](#block-guarded-by-piglins)
- [BLOCK_HOGLIN_REPELLENTS](#block-hoglin-repellents)
- [BLOCK_ICE](#block-ice)
- [BLOCK_IMPERMEABLE](#block-impermeable)
- [BLOCK_INFINIBURN_END](#block-infiniburn-end)
- [BLOCK_INFINIBURN_NETHER](#block-infiniburn-nether)
- [BLOCK_INFINIBURN_OVERWORLD](#block-infiniburn-overworld)
- [BLOCK_INSIDE_STEP_SOUND_BLOCKS](#block-inside-step-sound-blocks)
- [BLOCK_INVALID_SPAWN_INSIDE](#block-invalid-spawn-inside)
- [BLOCK_IRON_ORES](#block-iron-ores)
- [BLOCK_JUNGLE_LOGS](#block-jungle-logs)
- [BLOCK_LAPIS_ORES](#block-lapis-ores)
- [BLOCK_LAVA_POOL_STONE_CANNOT_REPLACE](#block-lava-pool-stone-cannot-replace)
- [BLOCK_LEAVES](#block-leaves)
- [BLOCK_LOGS](#block-logs)
- [BLOCK_LOGS_THAT_BURN](#block-logs-that-burn)
- [BLOCK_LUSH_GROUND_REPLACEABLE](#block-lush-ground-replaceable)
- [BLOCK_MAINTAINS_FARMLAND](#block-maintains-farmland)
- [BLOCK_MANGROVE_LOGS](#block-mangrove-logs)
- [BLOCK_MANGROVE_LOGS_CAN_GROW_THROUGH](#block-mangrove-logs-can-grow-through)
- [BLOCK_MANGROVE_ROOTS_CAN_GROW_THROUGH](#block-mangrove-roots-can-grow-through)
- [BLOCK_MOOSHROOMS_SPAWNABLE_ON](#block-mooshrooms-spawnable-on)
- [BLOCK_MOSS_REPLACEABLE](#block-moss-replaceable)
- [BLOCK_MUSHROOM_GROW_BLOCK](#block-mushroom-grow-block)
- [BLOCK_NEEDS_DIAMOND_TOOL](#block-needs-diamond-tool)
- [BLOCK_NEEDS_IRON_TOOL](#block-needs-iron-tool)
- [BLOCK_NEEDS_STONE_TOOL](#block-needs-stone-tool)
- [BLOCK_NETHER_CARVER_REPLACEABLES](#block-nether-carver-replaceables)
- [BLOCK_NYLIUM](#block-nylium)
- [BLOCK_OAK_LOGS](#block-oak-logs)
- [BLOCK_OCCLUDES_VIBRATION_SIGNALS](#block-occludes-vibration-signals)
- [BLOCK_OVERWORLD_CARVER_REPLACEABLES](#block-overworld-carver-replaceables)
- [BLOCK_OVERWORLD_NATURAL_LOGS](#block-overworld-natural-logs)
- [BLOCK_PARROTS_SPAWNABLE_ON](#block-parrots-spawnable-on)
- [BLOCK_PIGLIN_REPELLENTS](#block-piglin-repellents)
- [BLOCK_PLANKS](#block-planks)
- [BLOCK_POLAR_BEARS_SPAWNABLE_ON_ALTERNATE](#block-polar-bears-spawnable-on-alternate)
- [BLOCK_PORTALS](#block-portals)
- [BLOCK_PRESSURE_PLATES](#block-pressure-plates)
- [BLOCK_PREVENT_MOB_SPAWNING_INSIDE](#block-prevent-mob-spawning-inside)
- [BLOCK_RABBITS_SPAWNABLE_ON](#block-rabbits-spawnable-on)
- [BLOCK_RAILS](#block-rails)
- [BLOCK_REDSTONE_ORES](#block-redstone-ores)
- [BLOCK_REPLACEABLE](#block-replaceable)
- [BLOCK_REPLACEABLE_BY_TREES](#block-replaceable-by-trees)
- [BLOCK_SAND](#block-sand)
- [BLOCK_SAPLINGS](#block-saplings)
- [BLOCK_SCULK_REPLACEABLE](#block-sculk-replaceable)
- [BLOCK_SCULK_REPLACEABLE_WORLDGEN](#block-sculk-replaceable-worldgen)
- [BLOCK_SHULKER_BOXES](#block-shulker-boxes)
- [BLOCK_SIGNS](#block-signs)
- [BLOCK_SLABS](#block-slabs)
- [BLOCK_SMALL_DRIPLEAF_PLACEABLE](#block-small-dripleaf-placeable)
- [BLOCK_SMALL_FLOWERS](#block-small-flowers)
- [BLOCK_SMELTS_TO_GLASS](#block-smelts-to-glass)
- [BLOCK_SNAPS_GOAT_HORN](#block-snaps-goat-horn)
- [BLOCK_SNIFFER_DIGGABLE_BLOCK](#block-sniffer-diggable-block)
- [BLOCK_SNIFFER_EGG_HATCH_BOOST](#block-sniffer-egg-hatch-boost)
- [BLOCK_SNOW](#block-snow)
- [BLOCK_SNOW_LAYER_CAN_SURVIVE_ON](#block-snow-layer-can-survive-on)
- [BLOCK_SNOW_LAYER_CANNOT_SURVIVE_ON](#block-snow-layer-cannot-survive-on)
- [BLOCK_SOUL_FIRE_BASE_BLOCKS](#block-soul-fire-base-blocks)
- [BLOCK_SOUL_SPEED_BLOCKS](#block-soul-speed-blocks)
- [BLOCK_SPRUCE_LOGS](#block-spruce-logs)
- [BLOCK_STAIRS](#block-stairs)
- [BLOCK_STANDING_SIGNS](#block-standing-signs)
- [BLOCK_STONE_BRICKS](#block-stone-bricks)
- [BLOCK_STONE_BUTTONS](#block-stone-buttons)
- [BLOCK_STONE_ORE_REPLACEABLES](#block-stone-ore-replaceables)
- [BLOCK_STONE_PRESSURE_PLATES](#block-stone-pressure-plates)
- [BLOCK_STRIDER_WARM_BLOCKS](#block-strider-warm-blocks)
- [BLOCK_SWORD_EFFICIENT](#block-sword-efficient)
- [BLOCK_TALL_FLOWERS](#block-tall-flowers)
- [BLOCK_TERRACOTTA](#block-terracotta)
- [BLOCK_TRAIL_RUINS_REPLACEABLE](#block-trail-ruins-replaceable)
- [BLOCK_TRAPDOORS](#block-trapdoors)
- [BLOCK_UNDERWATER_BONEMEALS](#block-underwater-bonemeals)
- [BLOCK_UNSTABLE_BOTTOM_CENTER](#block-unstable-bottom-center)
- [BLOCK_VALID_SPAWN](#block-valid-spawn)
- [BLOCK_WALLS](#block-walls)
- [BLOCK_WALL_CORALS](#block-wall-corals)
- [BLOCK_WALL_HANGING_SIGNS](#block-wall-hanging-signs)
- [BLOCK_WALL_POST_OVERRIDE](#block-wall-post-override)
- [BLOCK_WALL_SIGNS](#block-wall-signs)
- [BLOCK_WARPED_STEMS](#block-warped-stems)
- [BLOCK_WART_BLOCKS](#block-wart-blocks)
- [BLOCK_WITHER_IMMUNE](#block-wither-immune)
- [BLOCK_WITHER_SUMMON_BASE_BLOCKS](#block-wither-summon-base-blocks)
- [BLOCK_WOLVES_SPAWNABLE_ON](#block-wolves-spawnable-on)
- [BLOCK_WOODEN_BUTTONS](#block-wooden-buttons)
- [BLOCK_WOODEN_DOORS](#block-wooden-doors)
- [BLOCK_WOODEN_FENCES](#block-wooden-fences)
- [BLOCK_WOODEN_PRESSURE_PLATES](#block-wooden-pressure-plates)
- [BLOCK_WOODEN_SLABS](#block-wooden-slabs)
- [BLOCK_WOODEN_STAIRS](#block-wooden-stairs)
- [BLOCK_WOODEN_TRAPDOORS](#block-wooden-trapdoors)
- [BLOCK_WOOL](#block-wool)
- [BLOCK_WOOL_CARPETS](#block-wool-carpets)
- [ENTITY_ARROWS](#entity-arrows)
- [ENTITY_AXOLOTL_ALWAYS_HOSTILES](#entity-axolotl-always-hostiles)
- [ENTITY_AXOLOTL_HUNT_TARGETS](#entity-axolotl-hunt-targets)
- [ENTITY_BEEHIVE_INHABITORS](#entity-beehive-inhabitors)
- [ENTITY_DISMOUNTS_UNDERWATER](#entity-dismounts-underwater)
- [ENTITY_FALL_DAMAGE_IMMUNE](#entity-fall-damage-immune)
- [ENTITY_FREEZE_HURTS_EXTRA_TYPES](#entity-freeze-hurts-extra-types)
- [ENTITY_FREEZE_IMMUNE_ENTITY_TYPES](#entity-freeze-immune-entity-types)
- [ENTITY_FROG_FOOD](#entity-frog-food)
- [ENTITY_IMPACT_PROJECTILES](#entity-impact-projectiles)
- [ENTITY_NON_CONTROLLING_RIDER](#entity-non-controlling-rider)
- [ENTITY_POWDER_SNOW_WALKABLE_MOBS](#entity-powder-snow-walkable-mobs)
- [ENTITY_RAIDERS](#entity-raiders)
- [ENTITY_SKELETONS](#entity-skeletons)
- [ITEM_ACACIA_LOGS](#item-acacia-logs)
- [ITEM_ANVIL](#item-anvil)
- [ITEM_ARROWS](#item-arrows)
- [ITEM_AXES](#item-axes)
- [ITEM_AXOLOTL_TEMPT_ITEMS](#item-axolotl-tempt-items)
- [ITEM_BAMBOO_BLOCKS](#item-bamboo-blocks)
- [ITEM_BANNERS](#item-banners)
- [ITEM_BEACON_PAYMENT_ITEMS](#item-beacon-payment-items)
- [ITEM_BEDS](#item-beds)
- [ITEM_BIRCH_LOGS](#item-birch-logs)
- [ITEM_BOATS](#item-boats)
- [ITEM_BOOKSHELF_BOOKS](#item-bookshelf-books)
- [ITEM_BREAKS_DECORATED_POTS](#item-breaks-decorated-pots)
- [ITEM_BUTTONS](#item-buttons)
- [ITEM_CANDLES](#item-candles)
- [ITEM_CHERRY_LOGS](#item-cherry-logs)
- [ITEM_CHEST_BOATS](#item-chest-boats)
- [ITEM_CLUSTER_MAX_HARVESTABLES](#item-cluster-max-harvestables)
- [ITEM_COAL_ORES](#item-coal-ores)
- [ITEM_COALS](#item-coals)
- [ITEM_COMPASSES](#item-compasses)
- [ITEM_COMPLETES_FIND_TREE_TUTORIAL](#item-completes-find-tree-tutorial)
- [ITEM_COPPER_ORES](#item-copper-ores)
- [ITEM_CREEPER_DROP_MUSIC_DISCS](#item-creeper-drop-music-discs)
- [ITEM_CREEPER_IGNITERS](#item-creeper-igniters)
- [ITEM_CRIMSON_STEMS](#item-crimson-stems)
- [ITEM_DAMPENS_VIBRATIONS](#item-dampens-vibrations)
- [ITEM_DARK_OAK_LOGS](#item-dark-oak-logs)
- [ITEM_DECORATED_POT_INGREDIENTS](#item-decorated-pot-ingredients)
- [ITEM_DECORATED_POT_SHERDS](#item-decorated-pot-sherds)
- [ITEM_DIAMOND_ORES](#item-diamond-ores)
- [ITEM_DIRT](#item-dirt)
- [ITEM_DOORS](#item-doors)
- [ITEM_EMERALD_ORES](#item-emerald-ores)
- [ITEM_FENCE_GATES](#item-fence-gates)
- [ITEM_FENCES](#item-fences)
- [ITEM_FISHES](#item-fishes)
- [ITEM_FLOWERS](#item-flowers)
- [ITEM_FOX_FOOD](#item-fox-food)
- [ITEM_FREEZE_IMMUNE_WEARABLES](#item-freeze-immune-wearables)
- [ITEM_GOLD_ORES](#item-gold-ores)
- [ITEM_HANGING_SIGNS](#item-hanging-signs)
- [ITEM_HOES](#item-hoes)
- [ITEM_IGNORED_BY_PIGLIN_BABIES](#item-ignored-by-piglin-babies)
- [ITEM_IRON_ORES](#item-iron-ores)
- [ITEM_JUNGLE_LOGS](#item-jungle-logs)
- [ITEM_LAPIS_ORES](#item-lapis-ores)
- [ITEM_LEAVES](#item-leaves)
- [ITEM_LECTERN_BOOKS](#item-lectern-books)
- [ITEM_LOGS](#item-logs)
- [ITEM_LOGS_THAT_BURN](#item-logs-that-burn)
- [ITEM_MANGROVE_LOGS](#item-mangrove-logs)
- [ITEM_MUSIC_DISCS](#item-music-discs)
- [ITEM_NON_FLAMMABLE_WOOD](#item-non-flammable-wood)
- [ITEM_NOTEBLOCK_TOP_INSTRUMENTS](#item-noteblock-top-instruments)
- [ITEM_OAK_LOGS](#item-oak-logs)
- [ITEM_PICKAXES](#item-pickaxes)
- [ITEM_PIGLIN_FOOD](#item-piglin-food)
- [ITEM_PIGLIN_LOVED](#item-piglin-loved)
- [ITEM_PIGLIN_REPELLENTS](#item-piglin-repellents)
- [ITEM_PLANKS](#item-planks)
- [ITEM_RAILS](#item-rails)
- [ITEM_REDSTONE_ORES](#item-redstone-ores)
- [ITEM_SAND](#item-sand)
- [ITEM_SAPLINGS](#item-saplings)
- [ITEM_SHOVELS](#item-shovels)
- [ITEM_SIGNS](#item-signs)
- [ITEM_SLABS](#item-slabs)
- [ITEM_SMALL_FLOWERS](#item-small-flowers)
- [ITEM_SMELTS_TO_GLASS](#item-smelts-to-glass)
- [ITEM_SNIFFER_FOOD](#item-sniffer-food)
- [ITEM_SOUL_FIRE_BASE_BLOCKS](#item-soul-fire-base-blocks)
- [ITEM_SPRUCE_LOGS](#item-spruce-logs)
- [ITEM_STAIRS](#item-stairs)
- [ITEM_STONE_BRICKS](#item-stone-bricks)
- [ITEM_STONE_BUTTONS](#item-stone-buttons)
- [ITEM_STONE_CRAFTING_MATERIALS](#item-stone-crafting-materials)
- [ITEM_STONE_TOOL_MATERIALS](#item-stone-tool-materials)
- [ITEM_SWORDS](#item-swords)
- [ITEM_TALL_FLOWERS](#item-tall-flowers)
- [ITEM_TERRACOTTA](#item-terracotta)
- [ITEM_TOOLS](#item-tools)
- [ITEM_TRAPDOORS](#item-trapdoors)
- [ITEM_TRIM_MATERIALS](#item-trim-materials)
- [ITEM_TRIM_TEMPLATES](#item-trim-templates)
- [ITEM_TRIMMABLE_ARMOR](#item-trimmable-armor)
- [ITEM_VILLAGER_PLANTABLE_SEEDS](#item-villager-plantable-seeds)
- [ITEM_WALLS](#item-walls)
- [ITEM_WARPED_STEMS](#item-warped-stems)
- [ITEM_WART_BLOCKS](#item-wart-blocks)
- [ITEM_WOODEN_BUTTONS](#item-wooden-buttons)
- [ITEM_WOODEN_DOORS](#item-wooden-doors)
- [ITEM_WOODEN_FENCES](#item-wooden-fences)
- [ITEM_WOODEN_PRESSURE_PLATES](#item-wooden-pressure-plates)
- [ITEM_WOODEN_SLABS](#item-wooden-slabs)
- [ITEM_WOODEN_STAIRS](#item-wooden-stairs)
- [ITEM_WOODEN_TRAPDOORS](#item-wooden-trapdoors)
- [ITEM_WOOL](#item-wool)
- [ITEM_WOOL_CARPETS](#item-wool-carpets)
- [FLUID_LAVA](#fluid-lava)
- [FLUID_WATER](#fluid-water)
- [DAMAGE_ALWAYS_HURTS_ENDER_DRAGONS](#damage-always-hurts-ender-dragons)
- [DAMAGE_ALWAYS_KILLS_ARMOR_STANDS](#damage-always-kills-armor-stands)
- [DAMAGE_ALWAYS_MOST_SIGNIFICANT_FALL](#damage-always-most-significant-fall)
- [DAMAGE_ALWAYS_TRIGGERS_SILVERFISH](#damage-always-triggers-silverfish)
- [DAMAGE_AVOIDS_GUARDIAN_THORNS](#damage-avoids-guardian-thorns)
- [DAMAGE_BURNS_ARMOR_STANDS](#damage-burns-armor-stands)
- [DAMAGE_BYPASSES_ARMOR](#damage-bypasses-armor)
- [DAMAGE_BYPASSES_COOLDOWN](#damage-bypasses-cooldown)
- [DAMAGE_BYPASSES_EFFECTS](#damage-bypasses-effects)
- [DAMAGE_BYPASSES_ENCHANTMENTS](#damage-bypasses-enchantments)
- [DAMAGE_BYPASSES_INVULNERABILITY](#damage-bypasses-invulnerability)
- [DAMAGE_BYPASSES_RESISTANCE](#damage-bypasses-resistance)
- [DAMAGE_BYPASSES_SHIELD](#damage-bypasses-shield)
- [DAMAGE_DAMAGES_HELMET](#damage-damages-helmet)
- [DAMAGE_IGNITES_ARMOR_STANDS](#damage-ignites-armor-stands)
- [DAMAGE_IS_DROWNING](#damage-is-drowning)
- [DAMAGE_IS_EXPLOSION](#damage-is-explosion)
- [DAMAGE_IS_FALL](#damage-is-fall)
- [DAMAGE_IS_FIRE](#damage-is-fire)
- [DAMAGE_IS_FREEZING](#damage-is-freezing)
- [DAMAGE_IS_LIGHTNING](#damage-is-lightning)
- [DAMAGE_IS_PROJECTILE](#damage-is-projectile)
- [DAMAGE_NO_ANGER](#damage-no-anger)
- [DAMAGE_NO_IMPACT](#damage-no-impact)
- [DAMAGE_NO_KNOCKBACK](#damage-no-knockback)
- [DAMAGE_WITCH_RESISTANT_TO](#damage-witch-resistant-to)
- [DAMAGE_WITHER_IMMUNE_TO](#damage-wither-immune-to)
...
## `BLOCK_ANCIENT_CITY_REPLACEABLE`
...
## `BLOCK_CAMEL_SAND_STEP_SOUND_BLOCKS`
...
## `BLOCK_COMBINATION_STEP_SOUND_BLOCKS`
...
## `BLOCK_COMPLETES_FIND_TREE_TUTORIAL`
...
## `BLOCK_DEEPSLATE_ORE_REPLACEABLES`
...
## `BLOCK_DRIPSTONE_REPLACEABLE_BLOCKS`
...
## `BLOCK_ENCHANTMENT_POWER_PROVIDER`
...
## `BLOCK_ENCHANTMENT_POWER_TRANSMITTER`
...
## `BLOCK_INSIDE_STEP_SOUND_BLOCKS`
...
## `BLOCK_LAVA_POOL_STONE_CANNOT_REPLACE`
...
## `BLOCK_MANGROVE_LOGS_CAN_GROW_THROUGH`
...
## `BLOCK_MANGROVE_ROOTS_CAN_GROW_THROUGH`
...
## `BLOCK_NETHER_CARVER_REPLACEABLES`
...
## `BLOCK_OCCLUDES_VIBRATION_SIGNALS`
...
## `BLOCK_OVERWORLD_CARVER_REPLACEABLES`
...
## `BLOCK_POLAR_BEARS_SPAWNABLE_ON_ALTERNATE`
...
## `BLOCK_PREVENT_MOB_SPAWNING_INSIDE`
...
## `BLOCK_SCULK_REPLACEABLE_WORLDGEN`
...
## `BLOCK_SMALL_DRIPLEAF_PLACEABLE`
...
## `BLOCK_SNOW_LAYER_CAN_SURVIVE_ON`
...
## `BLOCK_SNOW_LAYER_CANNOT_SURVIVE_ON`
...
## `BLOCK_WITHER_SUMMON_BASE_BLOCKS`
...
## `ENTITY_AXOLOTL_ALWAYS_HOSTILES`
...
## `ENTITY_FREEZE_HURTS_EXTRA_TYPES`
...
## `ENTITY_FREEZE_IMMUNE_ENTITY_TYPES`
...
## `ENTITY_POWDER_SNOW_WALKABLE_MOBS`
...
## `ITEM_COMPLETES_FIND_TREE_TUTORIAL`
...
## `ITEM_DECORATED_POT_INGREDIENTS`
...
## `ITEM_NOTEBLOCK_TOP_INSTRUMENTS`
...
## `DAMAGE_ALWAYS_HURTS_ENDER_DRAGONS`
...
## `DAMAGE_ALWAYS_KILLS_ARMOR_STANDS`
...
## `DAMAGE_ALWAYS_MOST_SIGNIFICANT_FALL`
...
## `DAMAGE_ALWAYS_TRIGGERS_SILVERFISH`
...
## `DAMAGE_BYPASSES_INVULNERABILITY`
